...
# Must match the Windows JDK used at runtime (e.g. Temurin 17 for PySpark).
set -euo pipefail

export JDK_MAJOR="${JDK_MAJOR:-17}"
export TEMURIN_WIN_TAG="${TEMURIN_WIN_TAG:-jdk-17.0.13+11}"
export TEMURIN_WIN_VERSION="${TEMURIN_WIN_VERSION:-17.0.13_11}"
