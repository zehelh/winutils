...
function hadoop_classpath_tools_hadoop-aws
{
  ...
  if [[ -f "${HADOOP_TOOLS_HOME}/${HADOOP_TOOLS_LIB_JARS_DIR}/analyticsaccelerator-s3-1.2.1.jar" ]]; then
    hadoop_add_classpath "${HADOOP_TOOLS_HOME}/${HADOOP_TOOLS_LIB_JARS_DIR}/analyticsaccelerator-s3-1.2.1.jar"
  fi
